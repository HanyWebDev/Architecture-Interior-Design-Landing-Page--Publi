...
one.onclick = function(){
  document.querySelector(".heroSection").style.setProperty("--hero-bg", `url("${images[0]}")`);
}

two.onclick = function(){
  document.querySelector(".heroSection").style.setProperty("--hero-bg", `url("${images[1]}")`);
}

three.onclick = function(){
  document.querySelector(".heroSection").style.setProperty("--hero-bg", `url("${images[2]}")`);
}


four.onclick = function(){
  document.querySelector(".heroSection").style.setProperty("--hero-bg", `url("${images[3]}")`);
}
